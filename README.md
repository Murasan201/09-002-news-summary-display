...
- **3.3V動作のSSD1306 OLEDモジュール**を使用します
- Raspberry Pi GPIO（3.3V）と電圧互換のため、**レベル変換器は不要**です
- 直接I2C接続で動作します
...
# コード内のアドレス（0x3C）を実際のアドレスに変更
# Change address (0x3C) in code to actual address
```
